                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="name" type="text" class="form-control "
                                        value="{{ old('name', $brand->name) }}" placeholder="  ">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="metadesc" cols="10" rows="2" class="form-control " placeholder="">{{ old('metadesc', $brand->metadesc) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakey" cols="10" rows="2" class="form-control " placeholder="">{{ old('metakey', $brand->metakey) }}</textarea>
